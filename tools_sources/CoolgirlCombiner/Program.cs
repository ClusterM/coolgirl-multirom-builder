    ...
    class Program
    {
        static int Main(string[] args)
        {
            ...
            if (needShowHelp)
            {
                ...
                Console.WriteLine(" CoolgirlCombiner.exe build --games <games.txt> --asm <games.asm> [--nesasm <nesasm.exe>] [--report <report.txt>] [--nosort] [--maxromsize sizemb] [--maxchrsize sizekb] [--language <language>] [--badsectors <sectors>] [--unif <multirom.unf>] [--nes20 multirom.nes] [--bin <multirom.bin>]");
                Console.WriteLine("  {0,-20}{1}", "--games", "- input plain text file with list of ROM files");
                Console.WriteLine("  {0,-20}{1}", "--asm", "- output file for loader");
